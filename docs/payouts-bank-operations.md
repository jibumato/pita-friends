...
- 締め: **毎週金曜締め・翌週水曜払い**(当該日が銀行休業日なら翌営業日)
...
3. 振込日はアプリ内の表示(`Wallet.tsx` の「毎週金曜締め・翌週水曜払い」)と
...
### 週次の運用日
- **金曜 23:59 締め**(それまでに `pending` になった申請が対象)
- **翌週水曜に振込実行**(月曜実行だと、金土日に不正の申し出があっても
  確認する営業日が無い。1営業日の確認余地を残すため水曜にしている)
- 水曜が銀行休業日なら翌営業日
