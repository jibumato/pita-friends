...
1. ◑ **マイグレーション適用**: 0001〜0056は適用済み(2026-07-27)。
   **0057〜0066が未適用**です。次の順に当ててください:
   ...
   <details><summary>適用済みの内容(0037〜0056)と、次に当てる0057〜0066</summary>
   ...
   | `0066_admin_console.sql` ← **最後** | 運営コンソール（保留の解除・通報の審査・換金・請求・健全性・操作記録。`docs/admin-console.md`） | 締切のある作業を毎回 SQL Editor で手打ちすることになる |
