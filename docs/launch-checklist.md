...
1. ◑ **マイグレーション適用**: 0001〜0052は適用済み(2026-07-27)。
   **`0053_favorites.sql`(推し登録)・`0054_favorite_slot_notify.sql`
   (推しへの枠通知)・`0055_play_history_with.sql`(一緒に遊んだ回数)が未適用**です。
   0053 → 0054 → 0055 の順に当ててください
   (0054は0053の `favorites` を参照するため、逆順では失敗します)。
   ...
   <details><summary>適用済みの内容(0037〜0052)と、次に当てる0053〜0055</summary>
