...
1. ◑ **マイグレーション適用**: 0001〜0079は適用済み(2026-07-31)。
   **`0080`(カード共有の監視・E-9)と `0081`(居住地の自己申告・G4)が未適用**です。
   この2つは順序の依存がないので、番号順に当てるだけで済みます。
   ...
   <details><summary>適用の順序(0057〜0081)と、飛ばしてはいけない依存関係</summary>
   ...
   <details><summary>各マイグレーションの内容(0037〜0081)</summary>
