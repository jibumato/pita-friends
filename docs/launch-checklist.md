...
1. ◑ **マイグレーション適用**: 0001〜0056は適用済み(2026-07-27)。
   **0057〜0076が未適用**です。次の順に当ててください:
   ...
   <details><summary>適用済みの内容(0037〜0056)と、次に当てる0057〜0076</summary>
...
| `0076_accounting_round2.sql` ← **最後** | 会計集計の科目を税理士の第2回指摘に合わせる（「未払金」→預り金の下位／**仮受金(換金手数料)**の追加／分別対象額の合計／フロー4項目） | 換金申請中の**手数料300コインがどの勘定にも現れず**、分別管理で守るべき額がずれる |
