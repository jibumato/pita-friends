...
1. ◑ **マイグレーション適用**: 0001〜0056は適用済み(2026-07-27)。
   **0057〜0064が未適用**です。次の順に当ててください:
   ...
   <details><summary>適用済みの内容(0037〜0056)と、次に当てる0057〜0063</summary>
   ...
   | `0065_lock_down_function_grants.sql` ← **最後** | 未ログインに開いていた関数を閉じる（**他人の予約表が読める / 監査台帳に嘘を書ける** の2件を実際に再現して修正。`docs/security-review.md`） | **公開してはいけない状態のまま**になる |
