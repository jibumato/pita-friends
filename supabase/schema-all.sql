...
-- ============================================================================
-- 0069_restore_gift_payout_hold.sql
-- ============================================================================
-- ============================================================
...
-- ============================================================================
-- 0070_accounting_reconciliation.sql
-- ============================================================================
-- ============================================================
...
-- ============================================================================
-- 0072_fast_release_no_retroactive.sql
-- ============================================================================
-- ============================================================
...
-- ====
-- 0074_monitoring_revoke_effect.sql
-- ====
-- ============================================================
...
-- ====
-- 0075_payment_dispute_freeze.sql
-- ====
-- ============================================================
...
-- ====
-- 0080_card_fingerprint_monitoring.sql
-- ====
-- ============================================================
...
-- ====
-- 0081_residency_declaration.sql
-- ====
-- ============================================================
...
-- ====
-- 0084_notification_prefs_selfheal.sql
-- ====
-- ============================================================
...
grant execute on function public.accounting_journal(date, date) to authenticated;
-- ====
-- 0087_new_user_purchase_limit.sql
-- ====
-- ============================================================
...
grant execute on function public.accounting_journal(date, date) to authenticated;
-- ====
-- 0089_expiry_notice_and_claim_window.sql
-- ====
-- ============================================================
...
grant execute on function public.accounting_journal(date, date) to authenticated;
-- ====
-- 0091_fee_rate_grandfathering.sql
-- ====
-- ============================================================
-- 0091: 料率の遡及適用を止める(G3)
--
...
grant execute on function public.host_dashboard(timestamptz) to authenticated;
-- ====
-- 0092_withdraw_clears_posts.sql
-- ====
-- ============================================================
...
-- ============================================================================
-- 0096_payment_method_on_purchase.sql
-- ============================================================================
-- ============================================================
...
-- ============================================================================
-- 0097_gift_as_two_obligations.sql
-- ============================================================================
-- ============================================================
...
-- ============================================================================
-- 0098_withdrawal_payout_and_suspension_coins.sql
-- ============================================================================
-- ============================================================
...
-- ============================================================================
-- 0100_final_payout_must_be_whole.sql
-- ============================================================================
-- ============================================================
