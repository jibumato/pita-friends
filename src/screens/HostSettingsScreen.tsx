      ...
      >
        ...
        <div style={{ borderTop: `1.5px solid ${C.divider}`, paddingTop: 8, display: 'flex', flexDirection: 'column', gap: 5 }}>
          ...
          <span style={{ fontSize: 10.5, color: C.muted, lineHeight: 1.7 }}>
            {/* 「ゲストへの返金のこと？」と読まれたので、誰の取り分の話かを先に書く。
                ここは**キャンセル時にピタメイト側の報酬になる分**のこと（規約 第8条の2
                第7項）。役務の対価ではなく機会損失の補償なので、利用料を取らない */}
            直前のキャンセルで<b style={{ color: C.ink }}>あなたの報酬になる分</b>
            （機会損失の補償）からは、利用料を差し引きません。全額があなたの報酬になります。
            表示の率は消費税を含みます。
          </span>
        </div>
      </div>
      ...
      >
        ...
        >
          ...
          <span style={{ fontSize: 10.5, lineHeight: 1.7, color: C.body }}>
            ・提供するのは「ゲームを一緒に遊ぶ時間」です。本来の目的以外の利用・勧誘は禁止
            <br />
